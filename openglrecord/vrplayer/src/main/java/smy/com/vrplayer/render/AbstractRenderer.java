...
import smy.com.recorder.GLRecoder;
 ...
 */
public abstract class AbstractRenderer implements CardboardView.StereoRenderer {
    ...
    private void initRecordDraw(int width, int height){
        GLRecoder.init(width, height, mEglConfig);
    }

    private void startRecordDraw(){
        if (!TextUtils.isEmpty(recordPath)){
            try {
                GLRecoder.startEncoder(new File(recordPath));
                isPaused = false;
