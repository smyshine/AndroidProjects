...
public class DualYUVRectObject extends BaseDualRectObject {
    ...
    public DualYUVRectObject(int screenW, int screenH, CombineParams params) {
        super(screenW,screenH, params);
        String fragShader = ShaderProgram.fetchShader(R.raw.stitch_yuv_dual_rect_frag_shader);
