...
public class CustomCardboardView extends CardboardView implements
    ...
    private void setStereoModeEnabled(boolean enabled){
        setVRModeEnabled(enabled);
        setSettingsButtonEnabled(enabled);
    }

    private boolean getStereoModeEnabled(){
        return getVRMode();
    }
    ...
    public void startRecord(String path){
        if (mVRRenderer != null){
            mVRRenderer.startRecord(path);
        }
    }

    public void stopRecord(){
        if (mVRRenderer != null){
            mVRRenderer.stopRecord();
        }
    }
}
