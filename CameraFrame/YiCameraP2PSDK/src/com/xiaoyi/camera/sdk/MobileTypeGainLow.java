 ...
 */
public class MobileTypeGainLow extends MobileType{

    public static final String TAG = "MobileTypeGainLow";


    private HashMap<String, MobileTypeStruct> mMobileList = null;
    private static MobileTypeGainLow sInstance = null;

    public static MobileTypeGainLow getInstance()
    {
        if(sInstance == null)
            synchronized (MobileTypeGainLow.class) {
                {
                    sInstance = new MobileTypeGainLow();
                }
            }
        return sInstance;
    }
    private MobileTypeGainLow()
    {
