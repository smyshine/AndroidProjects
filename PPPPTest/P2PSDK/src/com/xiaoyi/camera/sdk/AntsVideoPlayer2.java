...
public class AntsVideoPlayer2 extends FrameLayout implements OnTouchListener {

    public static final float FULL_SCREEN_MIN_SCALE = 1.0f;
    public static final float NOT_FULL_MIN_SCALE = 0.75f;
    public static final float MAX_SCALE = 4.0f;
    public static final float SURFACE_SCALE = 1.4f;
    public static final float SURFACE_SCALE_NEW = 1.5f;
    ...
    public AntsVideoPlayer2(Context context) {
        super(context);
        init(context);
    }

    public AntsVideoPlayer2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public AntsVideoPlayer2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mOnClickListener != null) {
                mOnClickListener.onClick(AntsVideoPlayer2.this);
            }
