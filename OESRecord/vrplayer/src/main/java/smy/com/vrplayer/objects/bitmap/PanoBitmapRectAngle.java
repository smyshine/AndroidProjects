...
/**
 * Created by SMY on 2017/5/16.
 */

public class PanoBitmapRectAngle extends XYVRBaseObject {
    ...
    private static final String mFragmentShader =
                    ...
                    "void main() {\n" +
                    "  gl_FragColor = texture2D(singleTexture, TexCoordOut);\n" +
                    "}\n";

    public PanoBitmapRectAngle(Bitmap bitmap){
